        ...
        <div className="section-inner">
          ...
          <div className="section-hero-data">
            ...
            <p className="hero-para">
              At Desi-Pijja, we don’t just make pijja. We make people happy. Pizzas
              was built on the belief that pizza night should be special, and we
              carry that belief into everything we do. With more than 5 years
              of experience under our belts, we understand how to best serve our desi
              customers through tried and true service principles: We create
              pijjas that we’re proud to serve and deliver it fast, with a smile.
            </p>
