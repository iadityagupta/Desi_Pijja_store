    ...
    <Wrapper>
          ...
          <div className="footer-content">
            ...
            <div className="col">
              ...
              <div className="c-item">
                <FaLocationArrow />
                <div className="text">Indore, Madhya Pradhesh, India</div>
              </div>
              <div className="c-item">
                <FaMobileAlt />
                <div className="text">Phone: 8982412164</div>
              </div>
              <div className="c-item">
                <FaEnvelope />
                <div className="text">Email: aditya453gupta@gmail.com</div>
              </div>
            </div>
            <div className="col">
      ...
      <div className="bottom-bar">
        <div className="bottom-bar-content">
          <div className="text">MADE WITH ❤️ BY Aditya</div>
        </div>
      </div>
    </Wrapper>
  );
